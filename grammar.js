module.exports = grammar({
  ...
  rules: {
    ...
    stmt_val: $ => seq('val', $._pattern, '=', $._expr, ';'),
    ...
    type_name: $ => prec.left(3, seq($.name, optional(seq('[', optional($._types), ']')))),
    ...
    query_group: $ => prec.left(2, seq('group', '{', optional($._query_stmts), '}', optional($._as))),
    query_over: $ => prec.left(2, seq('over', '{', optional($._query_stmts), '}', optional($._as))),
    ...
    expr_call: $ => prec(10, seq($._expr, '(', optional($._exprs), ')')),
